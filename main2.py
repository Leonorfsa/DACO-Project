...
#
##Data Standerization (To ensure mean=0 and std=1)
sampled_features = StandardScaler().fit_transform(sampled_features)
prediction=knn.predict(sampled_features)
    
#%% PREFORMANCE EVALUATION

prediction_image=np.reshape(prediction[0:2601],[51,51])
Functions.show2DImages(prediction_image, single_mask)
